...
<execution_context>
@/root/apps/telegram-api/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/root/apps/telegram-api/.claude/get-shit-done/workflows/execute-phase.md end-to-end.
