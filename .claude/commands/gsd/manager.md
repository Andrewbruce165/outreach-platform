...
<execution_context>
@/root/apps/telegram-api/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/root/apps/telegram-api/.claude/get-shit-done/workflows/manager.md end-to-end.
