...
<execution_context>
@/root/apps/telegram-api/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/root/apps/telegram-api/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
