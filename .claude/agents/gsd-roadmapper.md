...
Reference full template: `/root/apps/aimly/tg-outreach/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/apps/aimly/tg-outreach/.claude/get-shit-done/templates/state.md`.
