...
Reference full template: `/root/apps/telegram-api/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/apps/telegram-api/.claude/get-shit-done/templates/state.md`.
