          ...
          <div className="card">
            ...
            <div style={{ padding: "16px 18px" }}>
              <BarChart
                ...
                height={100}
              />
              <div style={{ display: "flex", gap: 16, marginTop: 12, fontSize: 11, color: "var(--text-muted)", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                  <span style={{ width: 9, height: 9, borderRadius: 2, background: "var(--tg-blue)" }}/>
                  Sent this hour
                </span>
