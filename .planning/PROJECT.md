...
- ✓ Вложение одного файла к первому сообщению кампании (auto-media доставка) + невидимая анти-спам вариация текста опенера (обход наивного дедупа Telegram) — Validated in Phase 24, кроме двух открытых пунктов: (1) doc-only живой смоук-тест ещё не подтвердил фото-рендеринг конкретно для .jpg; (2) собственный inbox UI платформы не отображает вложения — фикс принадлежит неисполненной Phase 23, не блокирует
