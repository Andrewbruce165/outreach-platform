...
- ✓ Отправка сообщений через PostgreSQL-очередь с rate limiting (4/мин, 20/час) — existing. Дневной потолок сообщений (150/день) выпилен в Phase 22 — дневной лимит теперь исключительно на НОВЫЕ чаты, через грейд аккаунта (см. запись ниже)
- ✓ Лимит «новых чатов в сутки» на уровне аккаунта (не кампании): грейд 1→3 растёт автоматически по возрасту (шаг 30 дней, дефолты 5/9/13), общий бюджет для рассылки и warmup-паринга, настраиваемая per-workspace лестница + ручной override — Validated in Phase 22 (D-01..D-17)
