...
- [x] 22-04-PLAN.md — remove rate_per_day from sender schemas/router + SenderResponse grade fields + PATCH /senders/{slug}/grade override [Wave 2, depends_on: 22-01] — D-04/D-12/D-15
